...
const RAW: RawCard[] = [
  ...
  { kind: "dare", audience: "her", tier: 1, text: "Same, on him. Two minutes, nowhere obvious." },
  ...
  { kind: "dare", audience: "him", tier: 3, text: "Make her ask out loud, in full sentences, before she gets it." },
  { kind: "dare", audience: "him", tier: 3, text: "Edge her twice. She asks properly before there's a third." },
  { kind: "dare", audience: "him", tier: 3, text: "Hand on her throat, and she only comes when you say she can." },
  ...
  { kind: "dare", audience: "him", tier: 3, text: "Feed it to her slowly with her head off the edge of the bed. Watch her the entire time." },
  { kind: "dare", audience: "him", tier: 3, text: "Bend her over and make her wait sixty seconds without looking back." },
  { kind: "dare", audience: "him", tier: 3, text: "From behind, hand in her hair, telling her she's good the whole way through." },
  { kind: "dare", audience: "him", tier: 3, text: "On her stomach, hips up, your hand on the back of her neck." },
  ...
  { kind: "dare", audience: "him", tier: 3, text: "Tell her what she's earned it for, then let her have it." },
