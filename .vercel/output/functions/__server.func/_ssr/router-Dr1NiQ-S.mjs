...
//#region node_modules/.nitro/vite/services/ssr/assets/router-Dr1NiQ-S.js
...
var styles_default = "/assets/styles-DFWtBeAT.css";
var APP_NAME = "Between Us";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "A private two-player truth or dare deck. Him and her. One pass each."
			},
			{
				name: "theme-color",
				content: "#0c0b0a"
...
var $$splitComponentImporter = () => import("./routes-ChKxPxu5.mjs");
